...
export default function SoulStudio(){
  ...
  const categories=useMemo(()=>['All','Comfort','Romance','Best friend','Roleplay','Adventure','Fantasy','Sci-fi','Books','Anime','Gaming','Travel','Motivation','Media Influencer','Bollywood','Hollywood','Actress','Cinema','Fashion','Lifestyle'],[]);
